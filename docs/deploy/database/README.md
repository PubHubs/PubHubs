...
The module `DBMigration` in `/pubhubs_hub/modules/pubhubs/DBMigration.py` calls the migration strategy. For example, the code below shows the migration strategy for Add columns migration, but this needs to be updated based on the migration strategy to be used.
