const nl = {
    ...
    rooms: {
        ...
        rooms: 'Gesprekken',
        search: 'Zoek gesprek of maak nieuw gesprek',
        title: '{0}',
        ...
        secured_room_error:
            'Het spijt ons, maar het lijkt erop dat u geen toegang heeft tot de kamer! Controleer uw gegevens in de Yivi-app',
    },
    settings: {
        displayname: 'Bijnaam',
