const nl = {
	...
	moderation: {
		...
		report_message: 'bericht melden',
		report_message_info: 'meld dit bericht bij de stewards van deze kamer',
		report_reason_label: 'reden voor het melden van dit bericht',
