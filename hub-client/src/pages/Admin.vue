							...
							<div class="flex w-full justify-between gap-8 overflow-hidden" :title="item.room_id">
								...
								<div class="flex w-fit gap-4">
									...
									<div class="flex items-center gap-1">
										...
										<Icon type="pencil-simple" class="hover:cursor-pointer hover:text-accent-primary" v-if="rooms.room(item.room_id)?.userCanChangeName(user.user.userId)" @click="EditSecuredRoom(item)" />
