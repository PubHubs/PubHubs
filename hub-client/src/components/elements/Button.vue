<template>
	<div
		role="button"
		:class="buttonClass"
		class="rounded-base relative line-clamp-1 block h-fit shrink-0 cursor-pointer text-center font-semibold whitespace-nowrap transition-all duration-150 ease-in-out"
		@click="click($event)"
		:disabled="disabled"
	>
		<slot></slot>
