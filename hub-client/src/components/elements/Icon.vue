<template>
	<div class="flex h-fit w-fit shrink-0 items-center justify-center" :data-testid="type">
		...
		<svg v-else viewBox="0 0 24 24" fill="transparent" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" :class="sizes[size]" v-html="icons[type]"></svg>
	</div>
</template>
