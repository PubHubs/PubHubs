<template>
	<button
		class="hover:bg-surface-base focus:bg-surface first-of-type:rounded-t-base last-of-type:rounded-b-base flex w-full flex-row gap-150 px-175 py-100 first-of-type:pt-150 last-of-type:pb-150 hover:cursor-pointer disabled:cursor-not-allowed"
		role="menuitem"
		type="button"
