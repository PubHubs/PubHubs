<template>
	<OnboardingTemplate>
		<template #column1>
			...
			<a
				class="text-label mt-400 hidden underline underline-offset-4 lg:block"
		...
		<template #column2>
			<div class="flex w-3/4 flex-col lg:w-full">
				<div class="-mt-200 mb-200 flex w-full lg:mt-0 lg:justify-center">
					<div
						id="yivi-register"
					...
					<div class="relative right-200 hidden w-3000 lg:flex">
						<img
				...
				<a
					class="text-label flex underline underline-offset-200 lg:hidden"
					href="javascript:void(0)"
					@click="$emit('back')"
					>&#x27F5; {{ $t('register.step_previous') }}</a
				>
			...
			<div class="lg:hidden">
				<img
					class="relative left-1/2 -mb-1400 w-2000 pb-200 md:left-3/4"
